...
export const MESSAGE_CLASSES = ["transactional", "daily_loop", "contextual", "marketing"] as const;
...
export const NOTIFICATION_CATEGORIES = ["morning", "night", "contextual", "festival", "marketing"] as const;
...
export const CONTEXTUAL_TRIGGERS = ["user_reminder", "muhurat_window", "festival_or_family", "reflection_followup", "transit_change", "quiet_reengagement"] as const;
export type ContextualTrigger = (typeof CONTEXTUAL_TRIGGERS)[number];
...
export const NOTIFICATION_STATUSES = ["queued", "sent", "delivered", "failed", "expired", "superseded"] as const;
...
export const PUSH_SUBSCRIPTION_STATES = ["active", "dead"] as const;
export type PushSubscriptionState = (typeof PUSH_SUBSCRIPTION_STATES)[number];
...
export const DELIVERY_FAILURES = ["subscription_gone", "transient", "rejected", "unconfigured"] as const;
export type DeliveryFailure = (typeof DELIVERY_FAILURES)[number];

/** §23.1's own labels. Documentation — the IDs are the wire format. */
export const MESSAGE_CLASS_LETTER: Record<MessageClass, string> = {
  transactional: "T",
  daily_loop: "D",
  contextual: "C",
  marketing: "M",
...
export const CONTEXTUAL_TRIGGER_PRIORITY = ["user_reminder", "muhurat_window", "festival_or_family", "reflection_followup", "transit_change", "quiet_reengagement"] as const;
...
export const MARKETING_WEEKLY_CAP = 2 as const;
...
export const QUIET_HOURS_DEFAULT_START = "22:30" as const;
...
export const QUIET_HOURS_DEFAULT_END = "07:00" as const;
...
export const PREFERENCE_APPLY_SECONDS = 60 as const;

/** §23.5 — 'one-tap "pause everything for a week" (Class T exempt, stated plainly)'. */
export const PAUSE_EVERYTHING_DAYS = 7 as const;
...
export const BRIEF_EXPIRY_LOCAL_HOUR = 12 as const;
...
export const NIGHT_NUDGE_EXPIRY_LOCAL = "23:30" as const;
...
export const OTP_EXPIRY_MINUTES = 10 as const;
...
export const DEDUPE_WINDOW_HOURS = 24 as const;
...
export const TRIGGER_AUTOPAUSE_OPEN_RATE = 0.15 as const;

/** §23.2 — the trailing window the open rate is measured over. */
export const TRIGGER_AUTOPAUSE_WINDOW_DAYS = 14 as const;

/** §23.8 — 'opt-out spike >2× baseline on any template (auto-pauses that template, flags admin)'. */
export const OPT_OUT_SPIKE_MULTIPLE = 2 as const;

/** §23.8 — 'morning-wave delivery <97% by +15 min (pages on-call)'. */
export const MORNING_WAVE_DELIVERY_FLOOR = 0.97 as const;

/** §23.8 — the '+15 min' the delivery floor is measured at. */
export const MORNING_WAVE_ALARM_MINUTES = 15 as const;
...
export const BRIEF_DELIVERY_SLO_MINUTES = 5 as const;

/** §23.8 — the 95% of that SLO. */
export const BRIEF_DELIVERY_SLO_RATE = 0.95 as const;
...
export const EMERGENCY_STOP_SECONDS = 30 as const;
...
export const LANGUAGE_HEALTH_BAND = 0.2 as const;
...
export interface TodayState {
  ...
  festival_calendar_available: boolean;
}
