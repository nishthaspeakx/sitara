...
- **Cartesia is VERIFIED (live API, 13 Aug 2026); Sarvam is UNVERIFIED** — no live call has been made against it and the response keys are read from docs. Same discipline as Prokerala-vs-DivineAPI; the skipping marker is honest, do not delete it.
